    ...
    <section className="relative min-h-screen flex items-center justify-center max-w-7xl mx-auto px-6 pt-24 pb-10 text-gray-900 dark:text-white">
      ...
      <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center w-full">
        ...
        <div>
          ...
          {/* TYPEWRITER */}
          <p className="text-blue-500 dark:text-blue-400 mt-7 text-base sm:text-lg md:text-xl lg:text-3xl font-medium h-[42px]">
            <Typewriter
              words={[
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10 w-full sm:w-auto flex-wrap">
            ...
            <button
              ...
              className="
                bg-blue-500 text-white px-7 lg:px-8 py-3.5 text-base sm:text-lg rounded-lg
            ...
            <a
              ...
              className="
                ...
                px-7 lg:px-8 py-3.5 rounded-lg
          ...
          <div className="mt-16 md:mt-20 text-gray-500 dark:text-gray-500 text-xs sm:text-sm md:text-base tracking-widest">
            SCROLL
          </div>
