...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="max-w-6xl mx-auto px-6 py-24 text-gray-900 dark:text-white"
    >
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-lg mb-8 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {[
              ...
              <a
                ...
                target="_blank"
                className={`
                  flex items-center gap-3 p-4 md:p-5 rounded-xl
                ...
                `}
              >
                <div className="shrink-0 text-lg md:text-xl">
                  {item.icon}
                </div>

                <div className="min-w-0">
                  <p className="text-sm sm:text-base md:text-lg font-semibold break-all md:break-normal">
                    {item.text}
                  </p>
        ...
        <div>
          <form ref={formRef} onSubmit={sendEmail} className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="
                    w-full mt-1 px-4 py-3.5 rounded-lg text-sm md:text-base
            ...
            <button
              type="submit"
              className="mt-2 w-full sm:w-fit px-7 py-3 bg-blue-500
              hover:bg-blue-600 transition rounded-lg text-sm md:text-base font-medium text-white"
            >
              ✈ Send Message
            </button>
