export default function Overview() {
  return (
    <section
      id="about"
      className="max-w-5xl mx-auto px-6 py-20 md:py-24 text-gray-900 dark:text-white"
    >

      {/* HEADER */}
      <p className="text-green-500 dark:text-green-400 tracking-[4px] text-[10px] sm:text-xs md:text-sm mb-3">
        // INTRODUCTION
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-start">
        ...
        {/* LEFT CONTENT */}
        <div>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base md:text-lg mb-6">
          ...
          <ul className="text-gray-700 dark:text-gray-300 text-sm sm:text-base md:text-lg space-y-2 mb-6">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base md:text-lg mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              target="_blank"
              className="px-5 py-3 text-sm sm:text-base md:text-lg bg-blue-500 hover:bg-blue-600 transition rounded-lg font-medium text-white text-center"
            >
              Connect on LinkedIn
            </a>
            ...
            <a
              ...
              target="_blank"
              className="
                px-5 py-3 rounded-lg text-sm sm:text-base md:text-lg text-center
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6">
          ...
          {[
            ...
            <div
              ...
              "
            >
              <p className={`text-2xl sm:text-3xl md:text-5xl font-bold ${item.color || "text-gray-900 dark:text-white"}`}>
                {item.value}
              </p>

              <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm md:text-lg mt-2 leading-snug">
                {item.label}
              </p>
            </div>
          ))}
